...
def speak_callout():
    ...
    path = os.path.join(CALLOUT_DIR, f"{key}.mp3")
...
correct_sounds = [
    pygame.mixer.Sound("sounds/correct.wav"),
    pygame.mixer.Sound("sounds/chime1.wav"),
    pygame.mixer.Sound("sounds/chime2.wav"),
]
...
def new_round():
    ...
    # her off mid-word.
    time.sleep(max(1.0, min(duration, 2.5)))


def animate_correct(fruit, milestone_text):
                ...
                for fruit in positions:
                    ...
                    if hitbox.collidepoint(
                        ...
                        if fruit == target:
                            ...
                            animate_correct(fruit, milestone_text)
